          ...
          <tfoot className="sticky bottom-0 z-10">
            <tr className="bg-white text-gray-900 font-black border-t-2 border-gray-200 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] h-[60px]">
              ...
              <td 
                ...
                onClick={() => selectedCity && onDrillDown({ city: drillCity, status: ClientStatus.ACTIVE })}
              >
                {totals.active}
              </td>
              <td 
                ...
                onClick={() => selectedCity && onDrillDown({ city: drillCity, status: ClientStatus.SEMI_ACTIVE })}
              >
                {totals.semi}
              </td>
              <td 
                ...
                onClick={() => selectedCity && onDrillDown({ city: drillCity, status: ClientStatus.INACTIVE })}
              >
                {totals.inactive}
              </td>
              <td 
                className="bg-gray-900 text-white p-4 text-center cursor-pointer hover:bg-gray-800 transition-colors"
                onClick={() => selectedCity && onDrillDown({ city: drillCity })}
              >
                {totals.total}
              </td>
            </tr>
